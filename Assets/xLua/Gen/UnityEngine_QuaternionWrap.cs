    ...
    public class UnityEngineQuaternionWrap 
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Quaternion)default) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Quaternion)default) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int __MulMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Quaternion)default) && translator.Assignable(L, 2, (UnityEngine.Quaternion)default))
				{
				...
				if (translator.Assignable(L, 1, (UnityEngine.Quaternion)default) && translator.Assignable(L, 2, (UnityEngine.Vector3)default))
				{
					UnityEngine.Quaternion leftside;translator.Get(L, 1, out leftside);
        ...
        static int _m_LookRotation_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable(L, 1, (UnityEngine.Vector3)default)) 
                {
        ...
        static int _m_SetLookRotation(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable(L, 2, (UnityEngine.Vector3)default)&& translator.Assignable(L, 3, (UnityEngine.Vector3)default)) 
                {
                    UnityEngine.Vector3 _view;translator.Get(L, 2, out _view);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Quaternion)default)) 
                {
