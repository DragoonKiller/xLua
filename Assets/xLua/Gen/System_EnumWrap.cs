    ...
    public class SystemEnumWrap 
    {
        ...
        static int _m_Parse_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    string _value = LuaAPI.lua_tostring(L, 2);
                    
                        var gen_ret = System.Enum.Parse( _enumType, _value );
                ...
                if(gen_param_count == 3&& translator.Assignable(L, 1, (System.Type)default)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    string _value = LuaAPI.lua_tostring(L, 2);
                    bool _ignoreCase = LuaAPI.lua_toboolean(L, 3);
                    
                        var gen_ret = System.Enum.Parse( _enumType, _value, _ignoreCase );
                        translator.PushAny(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        var gen_ret = System.Enum.GetUnderlyingType( _enumType );
		    ...
		    try {
                ...
                
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        var gen_ret = System.Enum.GetValues( _enumType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = System.Enum.GetName( _enumType, _value );
		    ...
		    try {
                ...
                
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                        ...
                        var gen_ret = System.Enum.GetNames( _enumType );
                        translator.Push(L, gen_ret);
        ...
        static int _m_ToObject_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    sbyte _value = (sbyte)LuaAPI.xlua_tointeger(L, 2);
                    
                        var gen_ret = System.Enum.ToObject( _enumType, _value );
                        translator.PushAny(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) || LuaAPI.lua_isint64(L, 2))) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) || LuaAPI.lua_isuint64(L, 2))) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& translator.Assignable(L, 2, (object)default)) 
                {
                    System.Type _enumType = (System.Type)translator.GetObject(L, 1, typeof(System.Type));
                    object _value = translator.GetObject(L, 2, typeof(object));
		    ...
		    try {
                ...
                
                {
                    ...
                    object _value = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = System.Enum.IsDefined( _enumType, _value );
		    ...
		    try {
                ...
                
                {
                    ...
                    string _format = LuaAPI.lua_tostring(L, 3);
                        ...
                        var gen_ret = System.Enum.Format( _enumType, _value, _format );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    object _target = translator.GetObject(L, 2, typeof(object));
                        ...
                        var gen_ret = gen_to_be_invoked.CompareTo( _target );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_GetTypeCode(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetTypeCode(  );
                        translator.Push(L, gen_ret);
        ...
        static int _m_TryParse_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 1, (System.Type)default)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    object _result;
                        ...
                        var gen_ret = System.Enum.TryParse( _enumType, _value, out _result );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable(L, 1, (System.Type)default)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    object _result;
                        ...
                        var gen_ret = System.Enum.TryParse( _enumType, _value, _ignoreCase, out _result );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    translator.PushAny(L, _result);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Enum.TryParse!");
