...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoundsWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable(L, 2, (UnityEngine.Vector3)default) && translator.Assignable(L, 3, (UnityEngine.Vector3)default))
				{
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Bounds)default) && translator.Assignable(L, 2, (UnityEngine.Bounds)default))
				{
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Bounds)default)) 
                {
        ...
        static int _m_IntersectRay(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Ray)default)) 
                {
