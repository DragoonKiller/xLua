    ...
    public class UnityEngineRectWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable(L, 2, (UnityEngine.Vector2)default) && translator.Assignable(L, 3, (UnityEngine.Vector2)default))
				{
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable(L, 2, (UnityEngine.Rect)default))
				{
        ...
        static int __EqMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Rect)default) && translator.Assignable(L, 2, (UnityEngine.Rect)default))
				{
        ...
        static int _m_Contains(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Vector2)default)) 
                {
                ...
                if(gen_param_count == 3&& translator.Assignable(L, 2, (UnityEngine.Vector3)default)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.Vector3 _point;translator.Get(L, 2, out _point);
        ...
        static int _m_Overlaps(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Rect)default)) 
                {
                ...
                if(gen_param_count == 3&& translator.Assignable(L, 2, (UnityEngine.Rect)default)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.Rect _other;translator.Get(L, 2, out _other);
                    bool _allowInverse = LuaAPI.lua_toboolean(L, 3);
