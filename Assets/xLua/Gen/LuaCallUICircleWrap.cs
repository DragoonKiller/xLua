...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaCallUICircleWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaCallUICircle);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetCircleRadiusOffset", _m_GetCircleRadiusOffset_xlua_st_);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "SetCircleRadiusOffset", _m_SetCircleRadiusOffset_xlua_st_);
        ...
        {
            return LuaAPI.luaL_error(L, "LuaCallUICircle does not have a constructor!");
        }
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleRadius( _id );
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleWidth( _id );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleSegments( _id );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetCircleRadiusOffset_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleRadiusOffset( _id );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCirclePercent( _id );
                        LuaAPI.lua_pushnumber(L, gen_ret);
        ...
        static int _m_SetCirclePercent_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCirclePercent( _id, _percent );
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleSubDivide( _id );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_SetCircleRadius_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCircleRadius( _id, _radius );
        ...
        static int _m_SetCircleSegments_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCircleSegments( _id, _segments );
        ...
        static int _m_SetCircleWidth_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCircleWidth( _id, _width );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetCircleRadiusOffset_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                    float _radiusOffset = (float)LuaAPI.lua_tonumber(L, 2);
                    
                    LuaCallUICircle.SetCircleRadiusOffset( _id, _radiusOffset );
        ...
        static int _m_SetCircleSubDivide_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCircleSubDivide( _id, _subDivide );
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleUVRepeat( _id );
                        LuaAPI.lua_pushnumber(L, gen_ret);
        ...
        static int _m_SetCircleUVRepeat_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.SetCircleUVRepeat( _id, _uvRepeat );
        ...
        static int _m_ForceUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaCallUICircle.ForceUpdate( _id );
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleEstimatedVertexCount( _id );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    NodeId _id;translator.Get(L, 1, out _id);
                        ...
                        var gen_ret = LuaCallUICircle.GetCircleWillExceedVertexLimit( _id );
