...
namespace XLua
{
    public static partial class CopyByValue
    {
		...
		public static void UnPack(ObjectTranslator translator, RealStatePtr L, int idx, out Coord val)
		{
		    val = new Coord();
            int top = LuaAPI.lua_gettop(L);
        ...
        public static bool Pack(IntPtr buff, int offset, Coord field)
        {
        ...
        public static bool UnPack(IntPtr buff, int offset, out Coord field)
        {
            field = default(Coord);
