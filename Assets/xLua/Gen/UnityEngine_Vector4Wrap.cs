    ...
    public class UnityEngineVector4Wrap 
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Vector4)default) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Vector4)default) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3))
				{
        ...
        static int __AddMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable(L, 1, (UnityEngine.Vector4)default) && translator.Assignable(L, 2, (UnityEngine.Vector4)default))
				{
        ...
        static int __MulMeta(RealStatePtr L)
        {
			...
			try {
				...
				if (LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) && translator.Assignable(L, 2, (UnityEngine.Vector4)default))
				{
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable(L, 2, (UnityEngine.Vector4)default)) 
                {
